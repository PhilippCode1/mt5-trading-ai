...
def test_gemessene_kostenlage_ergibt_ein_anderes_stop_budget() -> None:
    ...
    Der numerische Anker des Befunds. (Dieser eine Test waere auch gegen die alte
    Fassung gruen gewesen -- ``stop_budget`` konnte eine Messung schon verarbeiten.
    Rot wird die alte Fassung erst bei den Aufrufern weiter unten: dort wurde die
    Messung nie uebergeben, und genau das war der Befund.)
    """
